						...
						<table cellpadding="0" cellspacing="0">
							<tbody>
								...
								<?php
									...
									{
										$player =$database->query("SELECT * FROM users WHERE id = ".$row['uid']."");
			...
			<thead>
				...
				<?php
					...
					foreach($result as $row)
					{
						...
						$ally = $database->query("SELECT * FROM alidata WHERE id = ".$row['alli2']."");
						echo '
						<tr>
			...
			<thead>
				...
				<?php
					...
					foreach($result as $row)
					{
						...
						$ally =  $database->query("SELECT * FROM alidata WHERE id = ".$row['alli1']."");
						echo '
						<tr>
			...
			<thead>
				...
				<?php
					...
					foreach($result as $row)
					{
						...
						$ally1 =  $database->query("SELECT * FROM alidata WHERE id = ".$row['alli1']."");
						$ally2 =  $database->query("SELECT * FROM alidata WHERE id = ".$row['alli2']."");
						echo '
						<tr>
