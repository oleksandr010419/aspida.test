				...
				<?php
					...
					if($_SESSION['access'] == ADMIN)
					{
						...
						else if($user['tribe'] == 6)
						{
							...
							<tr>
								<td><center /><img src="../img/admin/en/u/51.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/52.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/53.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/54.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/55.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/56.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/57.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/58.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/59.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/60.gif"></img></td>
							</tr>
						...
						else if($user['tribe'] == 7)
						{
							...
							<tr>
								<td><center /><img src="../img/admin/en/u/61.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/62.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/63.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/64.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/65.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/66.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/67.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/68.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/69.gif"></img></td>
								<td><center /><img src="../img/admin/en/u/70.gif"></img></td>
							</tr>
