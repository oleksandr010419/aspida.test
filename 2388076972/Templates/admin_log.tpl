<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  ...
  <link REL="shortcut icon" HREF="favicon.ico"/>
	...
	<title><?php if($_SESSION['access'] == ADMIN){ echo 'Admin Control Panel'; } else if($_SESSION['access'] == MULTIHUNTER){ echo 'Multihunter Control Panel'; } ?></title>
...
<?php
       ...
       { echo '<a href="admin.php?p=player&uid='.$admid.'">'.$user.'</a>'; }
			?><br />
