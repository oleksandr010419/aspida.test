						...
						<table cellpadding="0" cellspacing="0">
							<tbody>
								...
								<?php
									...
									{
										$player = $database->single("SELECT * FROM users WHERE id = ".$row['uid']."");
			...
			<thead>
				...
				<?php
					...
					foreach($result as $row)
					{
						...
						$ally = $database->single("SELECT * FROM alidata WHERE id = ".$row['alli2']."");
						echo '
						<tr>
			...
			<thead>
				...
				<?php
					...
					foreach($result as $row)
					{
						...
						$ally = $database->single("SELECT * FROM alidata WHERE id = ".$row['alli1']."");
						echo '
						<tr>
			...
			<thead>
				...
				<?php
					...
					foreach($result as $row)
					{
						...
						$ally1 = $database->single("SELECT * FROM alidata WHERE id = ".$row['alli1']."");
						$ally2 = $database->single("SELECT * FROM alidata WHERE id = ".$row['alli2']."");
						echo '
						<tr>
