...
<body class="v35 <?=$database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> options <?php if($dorf1==''){echo 'perspectiveBuildings';}else{ echo 'perspectiveResources';} ?>">
<div id="background">
                    ...
                    <div id="content" class="options">
                            ...
                            <div class="contentNavi subNavi">
                                <div title="" class="container <?php if(!isset($_GET['s'])) { echo "active"; }else{ echo "normal"; } ?>">
                                    ...
                                    <div class="content"><a href="options.php"><span class="tabItem"><?=PROFM4?></span></a></div>
                                </div>
