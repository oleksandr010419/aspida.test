...
include_once(__DIR__."/../Data/buidata.php");
include_once(__DIR__."/../Database.php");
include_once(__DIR__."/../Attacks.php");
...
if($uids = $database->query("SELECT id FROM users WHERE id>6 AND username NOT LIKE '%Farm%' AND deleting=0 AND (logtime<".(time()-(60*60*24*7))." AND logtime>0)")){
