...
define("ATTACK1","Attack Bonus %");
define("ATTACK1_5","5%");
define("ATTACK1_10","10%");
define("ATTACK1_15","15%");
define("ATTACK1_20","20%");
define("ATTACK1_25","25%");
define("ATTACK1_30","30%");
define("ATTACK1_40","40%");
define("ATTACK1_50","50%");
define("ATTACK1_100","100%");
define("ATTACK2","Attack Bonus Cost");
define("DEF1","Defence Bonus %");
define("DEF1_5","5%");
define("DEF1_10","10%");
define("DEF1_15","15%");
define("DEF1_20","20%");
...
define("DEF1_50","50%");
define("DEF1_100","100%");
define("DEF2","Defence Bonus Cost");
define("OFF_DEF_TIME1","Duration Attack-Defence Bonus");
define("OFF_DEF_TIME_1","1 hour");
define("OFF_DEF_TIME_2","2 hours");
define("OFF_DEF_TIME_3","3 hours");
define("OFF_DEF_TIME_6","6 hours");
define("OFF_DEF_TIME_12","12 hours");
define("OFF_DEF_TIME_24","24 hours");
...
define("POP_TO_GET_GOLD1","Pop to get Gold");
...
define("ROUND_LENGTH1","Round Length (Days)");
define("ROUND_LENGTH2","We sugest the number to devide exactly with the number 3");
...
define("PLUS24","Complete all building and researching");
...
//profile
define("PROFHEAD","Player profile");
...
define('STATISTIC_COUNTRY', 'Country');
define('STATISTICS_COUNTRY_POINTS_CALC', 'The points for this ranking are assigned as follows: 1 point per player, 2 points per village, and 1 point per 1000 population.');
define('STATISTIC_FLAG', 'Flag');
define('STATISTIC_TOTAL_POPULATION', 'Total Population');
...
define("RULES2","Данные правила игры являются правилами разработанные администрацией xtravianx.net . В случае блокировки учетной записи, а также в целях лучшего понимания запрещенных действий, следует обратиться к Мультихантеру, к §3.<br>
...
define("RULES13","§2.3. Запрещается подражание официальным структурам xtravianx.net, как и использование имен, названий, носящих оскорбительный и некорректный характер с точки зрения нравственных и политических норм.");
...
define("RULES22","Все вопросы о нарушениях и наказаниях команда xtravianx.net   решает только с владельцем учетной записи.");
define("RULES23","§3.3. Команда xtravianx.net   оставляет за собой право изменения правила игры в любое время.");
define("PERC","Percent");
...
$lang['desc'][ 1 ] = array ( 0 => ' In the sawmill is timber production . With the increase in the level of development of the building increases its performance. ');
$lang['desc'][ 2 ] = array ( 0 => ' On clay quarry mined raw clay. With the development of a clay pit increases its performance. ');
$lang['desc'][ 3 ] = array ( 0 => ' On the iron mines miners extract valuable raw materials - iron. With the development of the mine increases its performance. ');
$lang['desc'][ 4 ] = array ( 0 => ' On farms grow grain to feed the population. With the development of the farm increases its performance . ');
...
$lang['desc'][ 11 ] = array ( 0 => 'Crop produced by your croplands is stored in the granary. By increasing its level, you increase the granarys capacity.');
...
$lang['desc'][ 15 ] = array ( 0 => ' The main building of the village builders live . higher level of the main building , the faster under construction . ');
$lang['desc'][ 16 ] = array ( 0 => ' In the collection point of your soldiers are going to the village. From here you can send reinforcements to organize a raid or conquer . ');
$lang['desc'][ 17 ] = array ( 0 => ' The market can be shared with other players feed. As the market increases the number of available merchants. ');
...
$lang['desc'][ 42 ] = array ( 0 => ' Wall protects your village from the attacks. higher the wall, the easier it is to defend the village from predatory raids and attacks by forces your opponents. ');
$lang['desc'][ 43 ] = array ( 0 => ' Wall protects your village from the attacks. higher the wall, the easier it is to defend the village from predatory raids and attacks by forces your opponents. ');

$lang['desc'][ 37 ] = array ( 0 => ' Στην περιοχή ηρώων μπορείτε να έχετε μια επισκόπηση των γύρο οάσεων. Αρχίζοντας από το κτίριο επίπεδο 10, μπορείτε να κατακτήσετε οάσεις με τον ήρωά σας και να αυξήσετε την παραγωγή υλών του χωριού σας. ') ;
...
$lang['desc'][ 41 ] = array ( 0 => ' Το μέρος ποτίσματος αλόγων φροντίζει για την υγεία των αλόγων σας, χαμηλώνει την κατανάλωση σιταριού και κάνει την εκπαίδευσή τους γρηγορότερη. Ανά επίπεδο, ο χρόνος εκπαίδευσης στον στάβλο σας μειώνεται κατά 1%. ');
$lang['desc'][ 44 ] = array ( 0 => ' The Waterworks allows you to regulate the water flow to your oases. This not only helps to grow trees and crops, but it is also useful for quarries and mines as it supplies workers with water and resource transportation. ');
$lang['desc'][ 45 ] = array ( 0 => ' The Waterworks allows you to regulate the water flow to your oases. This not only helps to grow trees and crops, but it is also useful for quarries and mines as it supplies workers with water and resource transportation. ');
...
$lang['descs'][9]=array(0=>array(4,10),array(15,5),array(8,5));
...
$lang['descs'][41]=array(0=>array(20,20),array(16,10));
		$lang['fields'] = array (
							0 => '&nbsp;level',
							1 => 'Лесопилка level',
							2 => 'Глиняный карьер level ',
							3 => 'Железный рудник level',
							4 => 'Ферма level',
		...
		$lang['upgrade'] = array (
							0 => 'The building already at the maximum level',
							1 => 'The maximum level of the building under construction',
							2 => 'The building is to be demolished',
							3 => '<b>cost</b> building up to level&nbsp;',
							4 => 'Workers are busy.',
							5 => 'Not enough food. Construct a farm.',
							6 => 'Build the warehouse.',
							7 => 'Build a granary.',
							8 => 'Enough resources&nbsp;',
							9 => '&nbsp;by&nbsp;&nbsp;',
							10 => 'Costs for upgrading to level &nbsp;',
							11 => 'today',
							12 => 'tomorrow');
...
define("UPG3","Costs");
define("UPG4","to build up to the level");
...
define("UPG11","Costs for upgrading to level ");
...
define ("PY12", "Troops in other villages or oasis ");
define ("PY13", "Reinforcement for ");
define ("PY14", "Withdraw ");
...
define("HEROI38","Fields Per Hour");
...
define("HEROI42","Hero is currently in village:");
define("HEROI43","Hero´s production:");
...
define("HEROA0","Location");
define("HEROA1","Time");
define("HEROA2","Difficulty");
define("HEROA3","Lime Left");
define("HEROA4","Link");
...
define("SIDE_I_7","");
define("CS","Building is fully upgraded");
...
define("PROTECTION_TIME","You will be under beginner protection for <b><span id=\"timer111\">%s</span></b>");
...
define("FIRST_DESC_COUNTRY_SELECT" , "Select your country for rankings");
define("FIRST_DESC_COUNTRY_FINAL" , "Note: Once this is saved, it cannot be changed.");
...
define("first_Roman_desc2" , "Specifications:");
...
define("first_Teutons_desc2" , "Specifications:");
...
define("JR_HERODELETEITEMS","Delete Items");
...
define("logint418","Land Distribution");
define("logint419","Send troops");
define("logint420","No information available!");
...
define("pluss39","Offense bonus");
define("pluss40","Defence bonus");
define("pluss41","");
define("pluss42","");
define("pluss43","");
define("pluss44","");
...
define("herohero2","Adventures");
define("herohero3","Auction");
define("herohero4","Buy Items");
define("herohero5","Sell Items");
define("herohero7","Delete Items");
define("herohero6","Random");

//ban_msg.tpl
define("yubnd","You are blocked. Write a letter to the administrator");
...
define("plus11", "Tarif");
define("plus12", "Buy");
define("plus13", "Buying gold for a different amount (UnitPay) (Rus)");
define("plus14", "Amount of payment");
define("plus15", "in total");
define("plus16", "*При покупке gold на сумму свыше 300 рублей золото выгоднее чем по тарифам!");
define("plus17", "В случае возникновения вопросов обращайтесь к");
define("plus18", "Administrator");
define("plus19", "После покупки gold необходимо перейти в");
define("plus20", "Банк");
...
define("plus24", "Здесь Хранится купленное/переведенное золото с прошлых раундов. (Если остаток превышал 100 монет)<br />Вы можете перевести его на <s>любой другой аккаунт</s> <b>ваш аккаунт</b>(мини-версия) в рамках Brainianz.ru");
...
define("plus52", "gold кликнув по иконке");
...
define ("TA7"," Costs for upgrading to level ");
define("newrpt","New reports: :");
...
define("rpts7","Recieve resources from");
...
define("rpts16","Prisoners dead upon release");
define("ot4m0","All");
define("ot4m1","Attack");
...
define("questday30","Visit our group in Facebook (clickable)");
...
//QUESTЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫЫ
...
define("quest174","Gifts every day");
define("quest175","Details");


//register mail
define("register1","Welcome to");
define("register2","Hello");
define("register3","Thank you for your registration.");
define("register4","Name");
define("register5","Password");
define("register6","Activation code");
define("register7","Click the following link in order to activate your account:");
define("register8","Greetings,");
define("register9","Team SpeedTravian");
define("register10","New password");
define("register11","You have requested a new password for Travian.");
define("register12","Please click this link to activate your new password. The old password then
becomes invalid:");
define("register13","If you want to change your new password, you can enter a new one in your profile
on tab account.");
define("register14","In case you did not request a new password you may ignore this email.");
