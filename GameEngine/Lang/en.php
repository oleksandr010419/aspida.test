...
define("WOOD","Lumber");
define("CLICK_FOR_MORE","Click for more information");
define("FULL_GRANARY","now");
define("PRODUCTION_MINES_THRESHOLD","Production less building upkeep");
define("EMPTY_GRANARY_IN","Granary will be empty in:");
...
define("LOGIN_WELCOME","Welcome to x".SPEED." server, round ".GAME_ROUND);
...
define("FREE_MERCHANTS","Free merchants: ");
//======================================================//
//================ UNITS - DO NOT EDIT! ================//
//======================================================//
// HEROE UNIT
...
define("U71"," Hoplite");
define("U72"," Sentinel");
define("U73"," Shieldsman");
define("U74","Twinsteel Therion");
define("U75","Elpida Rider");
define("U76","Corinthian Crusher");
define("U77","Ram");
define("U78","Ballista");
define("U79","Ephor");
define("U80","Settler");
...
define("ACCEPT_RULES"," I accept the game rules and general <a href='terms-en.pdf' target='_blank'>terms</a> and conditions.");
...
define("ACC16","Enter your password:");
define("ACC17","Yes");
define("ACC18","No");
...
define("OVERVIEW32","Octomber");
define("OVERVIEW33","November");
define("OVERVIEW34","December");
...
define("OVERVIEW41","Round");
define("OVERVIEW42","Server");
//medals
...
define("OTPRAV20","");
//Artefacti
define("ART1","Diamond Chisel");
define("ART2","Giant Marble Hammer");
define("ART3","Hemon's Scrolls");
define("ART4","Opal Horseshoe");
define("ART5","Golden Chariot");
define("ART6","Pheidippides' Sandals");
define("ART7","Tale of a Rat");
define("ART8","General's Letter");
define("ART9","Diary of Sun Tzu");
define("ART10","Scribed Soldier's Oath");
define("ART11","Declaration of War");
define("ART12","Memoirs of Alexander the Great");
define("ART13","Babylonian Tablet");
define("ART14","WW Buildingplan");
define("ART15","Access to the building.");
define("ART16","The buildings are more durable against attacks by catapults and rams. Does not count for the Wonder of the World.");
define("ART17","This artifact accelerates the movement of your troops.");
define("ART18","The Scouts, Equites Legati and Pathfinders are better at spying, and defending against spy attacks.Additionally, you can see the type of troops attacking you at your rally point, but not the amount of troops.");
define("ART19","Artifact reduces the training time of troops in barracks, stables and workshop.");
define("ART20","Grants ability to build great warehouse (GW) or great granary (GG).");
define("ART21","Artifact needed for the construction of Wonder.");
define("ART31","Silver Platter");
define("ART32","Sacred Hunting Bow");
define("ART33","King Arthur's Chalice");
define("ART34","The troops consume less crop.");
define("ART35","Map of the Hidden Caverns");
define("ART36","Bottomless Satchel");
define("ART37","Trojan Horse");
define("ART38","Artifact raises cranny capacity and additionally causes enemy catapult attacks to fire randomly. World Wonder can always be targeted and hit.");
define("ART41","Pendant of Mischief");
define("ART42","Forbidden Manuscript");
define("ART43","This artifact changes its effect every 24 hours, and can get any of the effects of other artifacts (except building plans for World Wonders, Great Granaries, and Great Warehouses). The effect scope (village or account) is randomly decided every 24 hours. Additionally, the magnitude of the effect is random (such as a 2x effect, 1.5x effect, 0.5x effect, etc.).");
define("ART44","Small artifacts of this type may also get negative effects. For example, troops might move slower, or they might consume more food. Unique artifact of this type may only get positive effects. For both types of artifacts the magnitude of the effect is still random. ");
define("ART45","Random");
//Map
define("BAN","Banned");
...
define("LINK4","");
//pravila anti-gad6I
define("RULES1","General Terms and Conditions");
...
$lang['desc'][ 1 ] = array ( 0 => ' The woodcutter cuts down trees in order to produce lumber. The further you extend the woodcutter, the more lumber is produced.<br><br>By constructing a sawmill, you can further increase the production.  ');
$lang['desc'][ 2 ] = array ( 0 => ' Here, clay is produced. By increasing its level, you increase clay production.<br><br>By constructing a brickyard, you can further increase the production. ');
$lang['desc'][ 3 ] = array ( 0 => ' Here, miners gather the precious resource of iron. By increasing the mine\'s level, you increase its iron production.<br><br>By constructing an iron foundry, you can further increase the production. ');
$lang['desc'][ 4 ] = array ( 0 => ' Your population s food is produced here. By increasing the cropland\s level, you increase crop production.<br><br>By constructing a grain mill and a bakery, you can further increase the production.  ');
...
$lang['desc'][ 10 ] = array ( 0 => 'The resources lumber, clay and iron are stored in the warehouse. By increasing its level, you increase your warehouse\'s capacity. Can be built multiple times, once one is built to max level. ');
$lang['desc'][ 11 ] = array ( 0 => 'The crop produced on your farms is stored in the granary. By increasing its level, you increase the granary\'s capacity. Can be built multiple times, once one is built to max level. ');
$lang['desc'][ 12 ] = array ( 0 => 'In the melter, better weapons can be forged for warriors. As the building develops, the maximum level of weapon improvement increases.<br><br>Additionally, the higher the level of the building, the faster the troops upgrade their weapons.');
...
$lang['desc'][ 15 ] = array ( 0 => ' The village\'s master builders live in the main building. The higher its level the faster your master builders complete the construction of new buildings.');
...
$lang['desc'][ 37 ] = array ( 0 => ' At levels 10, 15 and 20 of the hero\'s mansion, you can occupy an abandoned valley (oasis) using your hero, allowing up to three oases per village. Depending on the annexed oasis, you will get an increase of production for a certain resource (or even two with some oases).') ;
$lang['desc'][ 38 ] = array ( 0 => ' Large warehouse accommodates 3 ​​times more resources than a regular store. It requires You to have <b style="color:red">'.ART13.'</b> in Your posession. ');
$lang['desc'][ 39 ] = array ( 0 => ' Large barn accommodates 3 ​​times more resources than a conventional barn .  It requires You to have <b style="color:red">'.ART13.'</b> in Your posession.');
...
$lang['desc'][ 41 ] = array ( 0 => ' Thanks to watering your horses feel better and thus accelerated learning mounted troops and reduces the amount of grain consumed by them . ');
$lang['desc'][ 44 ] = array ( 0 => ' You can compare it to a Residence in almost all regards but instead of two, it features three expansion slots. You can only build a Command Center in villages without Palace and Residence and of course you cannot build either after the Command Center is built. ');
...
$lang['desc'][ 47 ] = array ( 0 => ' By building a defensive wall, you can protect your village against the barbarian hordes of your enemies. The higher its level, the higher the bonus given to your forces defense. The defensive wall can only be built by Spartans. Its defense bonus is like the Teutonic Earth Wall, and its durability is similar to the Gaul Palisade. ');
...
$lang['fields'] = array (
		...
		$lang['troops'] = array (
							0 => 'no',
							1 => 'Hero');
$lang['descs'][44]=array(0=>array(15,5));
$lang['descs'][45]=array(0=>array(37,10));
// Player statics
...
define("REPORT_FROM_VIL"," of village");
...
define("dvrc1","In order to found a new village you need a level 10 or 20 residence and 3 settlers. In order to conquer a new village you need a level 10 or 20 residence and a senator, chief or chieftain.");
...
define("gz5","Demolish Completely 5");
//COKRA
...
define("IEFF124","+500 to hero strength.For every Anhor Guard: +6 attack and +6 defence");
define("ITEM125","Spear of the Anhor Guard");
define("IEFF125","+1000 to hero strength.For every Anhor Guard: +8 attack and +8 defence");
define("ITEM126","Lance of the Anhor Guard");
define("IEFF126","+1500 to hero strength.For every Anhor Guard: +10 attack and +10 defence");
...
define("ITEM141","Composite LongBow of the Marksman");
...
define("UPGRADECOST","Costs for upgrading building to level %s");
...
define("punktxuev3","Send back");
define("punktxuev3_0","Call back");
define("punktxuev3_1","Send");
...
define("punktsb2","Redeploy the hero");
define("punktsb1","Duration");
//активация
...
define("sokr21","Inactive.");
define("sokr22","Active");
define("sokr23","Effect");
//taverna
...
define("questday23","(Next reset at 12:00 o'clock GMT. Make sure to collect your reward before!)");
...
define("REP_С16","");
define("REP_С17","Residence,Palace or Command Center not destroyed");
...
//register mail
define("register1","Welcome to x".SPEED." server");  
...
//last changes
define("suport1","Report a problem");
define("search8","search");
define("cropfind1","crop fields");
define("cropfind2","both");
define("cropfind3","Oasis bonus");
define("server_starting","The server will be started in:");
define("artefacts_comming","Artefacts will be released in:");
define("ww_plans_comming","Building plan will be released in:");
define("natars_comming","Natars will start building in:");
define("buy_adv1","Buy Adventure");
define("dif_adv1","Normal");
define("dif_adv2","Hard");
define("gold_to_silver","Change gold to silver");
define("silver_to_gold","Change silver to gold");
define("health_1","Health:");
define("experience_1","Εxperience:");
define("adv_1","Adventures");
define("adv_2","Available adventures:");
define("hero_over","Hero overview");
define("auc_1","Auctions");
define("cur_capacity_gr","Capacity");
define("cur_capacity_wr","Capacity");
define("next_capacity_gr","Capacity at level ");
define("next_capacity_wr","Capacity at level ");
define("sum_1","Sum: ");
define("sum_2","Rest: ");
define("npc_1","Change the resouces now");
define("cls_win","Close the window");
define("master_build_1","Construct with master builder");
define("reinf_1","Reinforcement for");
define("normal_attack_1","Attack against ");
define("normal_attack_2","Raid against ");
define("zoom_in","zoom in");
define("zoom_out","zoom out");
define("zoom_level","zoom level");
define("map_village","Village");
define("OVERVIEW_CN","Country");
define("STATISTIC_COUNTRY","Country");
define("STATISTIC_FLAG","Flag");
define("STATISTIC_TOTAL_POPULATION","Population per country");
define("MEDAL_51","Top Attacker");
define("MEDAL_52","Top Defender");
define("MEDAL_53","Builder of the World Wonder");
define("MEDAL_54","Player with highest polulatipn");
define("MEDAL_55","Member of the strongest alliance");
define("MEDAL_60","3 months with aspida veteran");
define("MEDAL_61","6 months with aspida veteran");
define("MEDAL_62","1 year with aspida veteran");
define("MEDAL_63","2 years with aspida veteran");
//error msgs
define("You_cant_reinforce_this_village_oasis","You can't reinforce this village/oasis");
define("You_cant_attack_this_village_oasis_with_normal_attack","You can't attack this village/oasis with normal attack");
define("You_cant_attack_this_village_oasis_with_raid_sitter_settings", "You can't attack this village/oasis with raid (sitter settings)");
define("You_cant_send_more_units_than_you_have","You can't send more units than you have");
define("You_cant_send_negative_units","You can't send negative units");
define("No_troops_have_been_selected","No troops have been selected");
define("Player_is_Banned_You_cant_attack_him","Player is Banned. You can't attack him");
define("You_cant_attack_same_village_you_are_sending_from","You can't attack same village you are sending from");
define("There_is_already_an_active_transaction","There is already an active transaction");
define("Wrong_destination","Wrong destination");
define("Troops_moving_away","Troops moving away...");
define("You_cant_change_someones_troops","You can't change someones troops");
define("You_cant_send_settlers_to_oases_field","You can't send settlers to oases field");
define("Creating_new_village","Creating new village");
define("Build_a_rally_point","Build a rally point");
define("hero_went_on_adventure","hero went on adventure");
define("Ummm_something_went_wrong","Ummm... something went wrong");
define("Insert_name_or_coordinates","Insert name or coordinates");
define("Player_is_under_beginners_protection_You_cant_attack_him","Player is under beginners protection. You can't attack him");
define("You_cant_attack_this_Natar_village_in_any_way","You can't attack this Natar village in any way");
define("exchange0","Exchange");
define("exchange1","Exchange");
define("exchange2","Not enough gold");
define("exchange3","Not enough silver");
define("exchange4","Exchange now");
define("exchange5","Exchange now");
define("exchange6","You do not have enough gold to use this feature!");
