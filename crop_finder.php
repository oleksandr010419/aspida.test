...
<body class="v35 <?=$database->bodyClass($_SERVER['HTTP_USER_AGENT']); ?> cropfinder <?php if($dorf1==''){echo 'perspectiveBuildings';}else{ echo 'perspectiveResources';} ?>">
...
<br />
<form style="margin-left:0px;" action="<?php echo $_SERVER['PHP_SELF']; ?>?s" method="post">
    <div class="boxes boxesColor gray" style="width: 99%">
        ...
        <thead>
        <tr >
            <td colspan="1"><?php echo FINDER3;?></td>
			<td colspan="3"><b>X: </b><input type="text" class="text" name="x" value="<?php print $coor2['x']; ?>" size="1" />
			<b>Y: </b><input type="text" class="text" name="y" value="<?php print $coor2['y']; ?>" size="1" /></td>
         </tr>
			<tr style="width=100%">
			<td><?php echo FINDER4;?></td>
			<td><input type="radio" class="radio" name="type" value="15" <?php if($_POST['type'] == 15 ) { print 'checked="checked"'; } ?>></input>15 <?php echo cropfind1; ?></td>
            <td><input type="radio" class="radio" name="type" value="9" <?php if($_POST['type'] == 9) { print 'checked="checked"'; } ?>></input>9 <?php echo cropfind1; ?></td>
            <td><input type="radio" class="radio" name="type" value="both" <?php if($_POST['type'] == 'both') { print 'checked="checked"'; } ?>></input>&nbsp;<?php echo cropfind2; ?></td>
          </tr>
			<tr>
			<td colspan="2"><?php echo cropfind3?></td>
			<td><select name="oasissize"  class="dropdown">
				...
				<tr>
            <td colspan="2" ><?php echo FINDER6;?>
			<input type="checkbox"  name="unoccupied" value="1" <?php if($_POST['unoccupied'] == 1){ print 'checked="checked"';}?>>&nbsp;<?php echo FINDER7;?></td>
        </tr>
        </thead>
    ...
    <button type="submit" value="ok" name="s1" id="btn_ok" class="green ">
        <div class="button-container addHoverClick">
            ...
            <div class="button-content"><?php echo search8;?></div></div></button>
</form>
...
if($_POST['type'] == 15) {
    ?>
    <br /><center><img src="gpack/delusion_4.4/img/g/f6-ltr.jpg" height="360"></center><br />
    <table cellpadding="1" cellspacing="1" id="croplist">
        <thead>
        <tr>
            <th colspan='5'><center>15</th>
        </tr>
        <tr>
            <td><center><?php echo FINDER8;?></td>
            <td><center><?php echo FINDER9;?></td>
            <td><center><?php echo FINDER4;?></td>
            <td><center><?php echo FINDER5;?></td>
            <td><center><?php echo FINDER10;?></td>
        </tr>
        </thead>
        <tbody>
        <?php
...
//echo "<br>for vil ".$row['id']."<br>";
                if($_POST['oasissize']=="any" or $_POST['oasissize']==$croppercents  or ($_POST['oasissize']==150 and $croppercents>=150)){
                    echo "<tr>";
                    if($row['occupied'] == 0) {
                        echo "<td class=\"dist\"><center><font color=\"black\">".$database->getDistance($coor['x'], $coor['y'], $row['x'], $row['y'])."</font></td>";
                        echo "<td class=\"aligned_coords\"><center><a href=\"karte.php?d=".$row['id']."&c=".$generator->getMapCheck($row['id'])."\">(".$row['x']."|".$row['y'].")</a></td>";
                        echo "<td class=\"typ\"><font color=\"black\"><img src=\"img/x.gif\" class=\"r4\" alt=".CROP_COM." title=".CROP_COM."> 15</font></td>";
                        echo "<td class=\"oase\"><img src=\"img/x.gif\" class=\"r4\" alt=".CROP_COM." title=".CROP_COM."> - ".$croppercents."%</td>";
                        echo "<td class=\"owned\">-</td>";
                    } else {
                        $vilain=$database->getUserInfoByVillageID($row['id']);
                        echo "<td class=\"dist\"><center><font color=\"black\">".$database->getDistance($coor['x'], $coor['y'], $row['x'], $row['y'])."</font></td>";
                        echo "<td class=\"aligned_coords\"><center><a href=\"karte.php?d=".$row['id']."&c=".$generator->getMapCheck($row['id'])."\">(".$row['x']."|".$row['y'].")</a></td>";
                        echo "<td class=\"typ\"><font color=\"black\"><img src=\"img/x.gif\" class=\"r4\" alt=".CROP_COM." title=".CROP_COM."> 15</font></td>";
                        echo "<td class=\"oase\"><img src=\"img/x.gif\" class=\"r4\" alt=".CROP_COM." title=".CROP_COM."> - ".$croppercents."%</td>";
...
<?php
    ...
    ?>
    <br /><center><img src="gpack/delusion_4.4/img/g/f1-ltr.jpg" height="360"></center><br />
    <table cellpadding="1" cellspacing="1" id="croplist">
        <thead>
        <tr>
            <th  colspan='5'  ><center>9</th>
        </tr>
        <tr>
            <td><center><?php echo FINDER8;?></td>
            <td><center><?php echo FINDER9;?></td>
...
//echo "<br>for vil ".$row['id']."<br>";
                if($_POST['oasissize']=="any" or $_POST['oasissize']==$croppercents  or ($_POST['oasissize']==150 and $croppercents>=150)){
                    ...
                    if($row['occupied'] == 0) {
                        echo "<td class=\"dist\"><center><font color=\"black\">".$database->getDistance($coor['x'], $coor['y'], $row['x'], $row['y'])."</font></td>";
                        echo "<td class=\"aligned_coords\"><center><a href=\"karte.php?d=".$row['id']."&c=".$generator->getMapCheck($row['id'])."\">(".$row['x']."|".$row['y'].")</a></td>";
                        echo "<td class=\"typ\"><font color=\"black\"><img src=\"img/x.gif\" class=\"r4\" alt=".CROP_COM." title=".CROP_COM."> 9</font></td>";
                        echo "<td class=\"oase\"><img src=\"img/x.gif\" class=\"r4\" alt=".CROP_COM." title=".CROP_COM."> - ".$croppercents."%</td>";
                        echo "<td class=\"owned\">-</td>";
                    } else {
...
<?php
    ...
    ?>
    <br /><center><img src="gpack/delusion_4.4/img/g/f1-ltr.jpg" height="200" width="250px"><img src="gpack/delusion_4.4/img/g/f6-ltr.jpg" height="200" width="250px"></center><br />
    <table cellpadding="1" cellspacing="1" id="croplist">
        <thead>
        <tr>
            <th colspan='5'><center>9 & 15</th>
        </tr>
        <tr>
            <td><center><?php echo FINDER8;?></td>
            <td><center><?php echo FINDER9;?></td>
...
//echo "<br>for vil ".$row['id']."<br>";
                if($_POST['oasissize']=="any" or $_POST['oasissize']==$croppercents  or ($_POST['oasissize']==150 and $croppercents>=150)){
                    ...
                    if($row['occupied'] == 0) {
                        echo "<td class=\"dist\"><center><font color=\"black\">".$database->getDistance($coor['x'], $coor['y'], $row['x'], $row['y'])."</font></td>";
                        echo "<td class=\"aligned_coords\"><center><a href=\"karte.php?d=".$row['id']."&c=".$generator->getMapCheck($row['id'])."\">(".$row['x']."|".$row['y'].")</a></td>";
                        echo "<td class=\"typ\"><font color=\"black\"><img src=\"img/x.gif\" class=\"r4\" alt=".CROP_COM." title=".CROP_COM."> ".$field."</font></td>";
                        echo "<td class=\"oase\"><img src=\"img/x.gif\" class=\"r4\" alt=".CROP_COM." title=".CROP_COM."> - ".$croppercents."%</td>";
                        echo "<td class=\"owned\">-</td>";
                    } else {
                        $vilain=$database->getUserNameByVilID($row['id']);
