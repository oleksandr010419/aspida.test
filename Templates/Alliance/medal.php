...
$profiel = preg_replace("/\[#".$medal['id']."]/is",'<img src="'.$gpack.'img/t/'.$medal['img'].'.gif" border="0" title="'.OVERVIEW36.': '.$titel.'<br />'.$ochki.': '.$medal['points'].'<br />'.$whatka.': '.$medal['week'].'">', $profiel, 1);
