...
<div class="paper">
    ...
    <div id="sender">
        ...
        <div class="header text"><?php echo $database->RemoveXSS($database->getUserField($message->reading['owner'],"username",0)); ?></div>
        <div class="clear"></div>
    </div>
    <div id="subject">
        <div class="header label"><?php echo mestena; ?></div>
        <div class="header text"><?php echo $database->RemoveXSS($message->reading['topic']); ?></div>
    <div class="clear"></div>
</div>
