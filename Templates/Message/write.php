<div id="messageNavigation">
    <div id="backToInbox">
        <a href="nachrichten.php"><?=MSG12?></a>
    </div>
    <div class="clear"></div>
</div>
<div id="write_head" class="msg_head"></div>
<div id="write_content" class="msg_content">
    <form method="post" action="nachrichten.php?t=1" accept-charset="UTF-8" name="msg">
        <div class="paper">
            <div class="layout">
                <div class="paperTop">
                ...
                <div id="subject">
                    ...
                    <div class="header text"><input tabindex="2" class="text" maxlength="50" name="be" id="subject" type="text" value="<?php if(isset($message->reply['topic']))
                        {
...
<button type="button" class="icon bbButton bbBold bbType{d} bbTag{b}"><img src="img/x.gif" class="bbBold" alt="bbBold"></button>
<button type="button" class="icon bbButton bbItalic bbType{d} bbTag{i}"><img src="img/x.gif" class="bbItalic" alt="bbItalic"></button>
<button type="button" class="icon bbButton bbUnderscore bbType{d} bbTag{u}"><img src="img/x.gif" class="bbUnderscore" alt="bbUnderscore"></button>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="button" id="message_resourceButton" class="icon bbWin{resources} bbButton bbResource"><img src="img/x.gif" class="bbResource" alt="bbResource"></button>
<button type="button" id="message_smilieButton" class="icon bbWin{smilies} bbButton bbSmilies"><img src="img/x.gif" class="bbSmilies" alt="bbSmilies"></button>
<button type="button" id="message_troopButton" class="icon bbWin{troops} bbButton bbTroops"><img src="img/x.gif" class="bbTroops" alt="bbTroops"></button>
<div class="clear"></div>
					<div id="message_toolbarWindows" class="bbToolbarWindow">
                        ...
                        <textarea id="message" name="message" class="messageEditor" tabindex="3" cols="1" rows="1"><?php if(isset($message->reply['message'])) { echo " \n_________________________
Reply:
