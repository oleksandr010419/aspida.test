    ...
    <div id="options">
                ...
                echo ($basearray['fieldtype']==0)?
                    ...
                    ($village->resarray['f39']==0)?
                        ...
                        ($basearray['owner'] == $session->uid)?
                            ...
                            "<a class=\"a arrow\" href=\"build.php?id=39\"> ".KAR9." (".KAR8.")</a>" :
                        ...
                        "<a class=\"a arrow\" href=\"a2b.php?z=".$getd."\"> ".KAR9."</a>" :
        ...
        <?php }
            ...
            <div class="option">
                ...
                if($uinfo['access']=='0' || $uinfo['access']=='8' || $uinfo['access']=='9') {
                    ...
                    echo $village->resarray['f39']? "<a class=\"a arrow\" href=\"a2b.php?z=".$getd."\"> ".KAR9."</a>" : "<span class=\"a arrow disabled\">".KAR9." (".KAR8.")</span>";
            ...
            <div class="option">
                ...
                if($uinfo['access']=='0' || $uinfo['access']=='8' || $uinfo['access']=='9') {
                    ...
                    echo $database->getTypeLvlFdata(17,$village->resarray)? "<a class=\"a arrow\" href=\"build.php?z=".$getd."&id=" . $database->getTypeField(17,$village->resarray) . "\"> ".KAR11."</a>" : "<span class=\"a arrow disabled\"> ".KAR11." (".KAR17.")</span>";
        ...
        <?php }else if ($basearray['occupied']==1 && $basearray['oasistype']!=0 && $basearray['wref'] != $_SESSION['wid']) { ?>
            ...
            <div class="option">
                ...
                echo $village->resarray['f39']? "<a class=\"a arrow\" href=\"a2b.php?z=".$d."\">Send troops.</a>" : "<span class=\"a arrow disabled\" title=\"(build rally point)\">".OTPRAV1."</span>";
			...
			<div class="option">
				<?php if(!$session->goldclub && $session->right['s4']) { 
					echo "<a class=\"a arrow\" target=\"_top\" href=\"build.php?id=39&t=99\">Add to farm list</a>";
				 } else { 
