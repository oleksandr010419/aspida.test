			...
			<th colspan="2"><?=rinok53?></th>
				...
				<tr>
					<th>
						<?=rinok50?>:					</th>
					<td>
                        <img class="r1" src="img/x.gif" alt="Wood" title="<?=LUMBER?>"> <input class="text" type="text" name="r1" id="r1" value="<?=$edited_route['wood']?>" maxlength="5" tabindex="1" style="width:50px;">
