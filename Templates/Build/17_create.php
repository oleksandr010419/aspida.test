...
?>						</select>
				...
				<tr>
					<th>
						<?=rinok50?>:					</th>
					<td>
						<img class="r1" src="img/x.gif" alt="Wood" title="<?=LUMBER?>"> <input class="text" type="text" name="r1" id="r1" value="0" maxlength="20" tabindex="1" style="width:75px;">
                        <img class="r2" src="img/x.gif" alt="Clay" title="<?=CLAY?>"> <input class="text" type="text" name="r2" id="r2" value="0" maxlength="20" tabindex="1" style="width:75px;">
                        <img class="r3" src="img/x.gif" alt="Iron" title="<?=IRON?>"> <input class="text" type="text" name="r3" id="r3" value="0" maxlength="20" tabindex="1" style="width:75px;">
                        <img class="r4" src="img/x.gif" alt="Crop" title="<?=CROP?>"> <input class="text" type="text" name="r4" id="r4" value="0" maxlength="20" tabindex="1" style="width:75px;">
