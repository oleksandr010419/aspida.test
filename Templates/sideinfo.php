...
<div id="sidebarBoxHero" class="sidebarBox toggleable <?php if($_COOKIE['box']==1){echo 'expanded';}else{ echo 'collapsed';}?> ">
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
            <button id="heroImageButton" onclick="window.location.href='hero_inventory.php';" class="heroImageButton " type="button" title="Hero overview||<?=$where?>">
                <img class="heroImage" src="<?=$database->herface();?>" width="64px" height="83px" style="margin-left:10px;margin-top:5px;" alt="">
            </button>
            <?php
...
?>            <div class="playerName">
                <img src="img/x.gif" class="nation nation<?php echo $session->tribe; ?>" alt="<?=$ttitle?>" title="<?=$ttitle?>"><?php echo $session->username; ?></div>
            ...
            ?>
            <button type="button" id="button5225ee283b28a" class="layoutButton adventureWhite green  "  title="Adventure:||Available adventures: <?php echo count($adventures); ?>" onclick="return false;">
                <div class="button-container addHoverClick ">
                    <img src="img/x.gif" alt="">
                </div>
                <?php
...
<div class="innerBox footer expanded"> <!-- Added the 'expanded' class here -->
    <button type="button" class="toggle" onclick="" title="Hide information">
        <div class="button-container addHoverClick ">
            <?php echo getsvgicon();?>
        </div>
    </button>
...
<div id="sidebarBoxAlliance" class="sidebarBox   ">
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
            <button type="button" id="button5225ee283d5ac" class="layoutButton embassyWhite green <?php if(!$posolstvo){ echo "disabled";}?>"  <?php if($posolstvo>0){echo "title='Embassy || Highest embassy level: ".$posolstvo."'";} ?> onclick="<?php echo $link;?> return false;">
                <div class="button-container addHoverClick">
                    <img src="img/x.gif" alt="">
                </div>
            </button>
...
<button type="button" id="button5225ee283d8f8" title="Alliance Review" class="layoutButton overviewWhite green <?php if(!$session->alliance) echo "disabled"; ?> " onclick="return false;">
                <div class="button-container addHoverClick ">
                    <img src="img/x.gif" alt="">
                </div>
            </button>
...
?>
            ...
            <div class="innerBox content">
                <ul><li><b>KIND REMINDER - MULTIACCOUNT IS FORBIDDEN</b> and results in ban</li></ul>
                <ul>
                ...
                <div class="innerBox content">
                    <form>
                        <div class="questAchievementContainer share_buttons">
                            <button questbuttonoverviewachievements="1" class="green questButtonOverviewAchievements goldVote disabled large" value="Подробности" data-id="vote1" data-set="<?=$session->vote1_link?>">
                                <div class="button-container addHoverClick ">
                            ...
                            <button questbuttonoverviewachievements="1" class="green questButtonOverviewAchievements goldVote disabled large" value="Подробности" data-id="vote2" data-set="<?=$session->vote2_link?>">
                                <div class="button-container addHoverClick ">
                                    <div class="button-background">
                                        <div class="buttonStart">
                                            <div class="buttonEnd">
                            ...
                            <button questbuttonoverviewachievements="1" class="green questButtonOverviewAchievements goldVote disabled large" value="Подробности" data-id="vote3" data-set="<?=$session->vote3_link?>">
                                <div class="button-container addHoverClick ">
                                    <div class="button-background">
                                        <div class="buttonStart">
                                            <div class="buttonEnd">
                            ...
                            <button class="green questButtonOverviewAchievements disabled share_button" id="fbShareBtn">
                                <div class="button-container addHoverClick ">
                                    ...
                                    <div class="button-content" id="share1" data-str="Share with FB"><img src="/<?php echo GP_LOCATE; ?>/img/Facebook-Share-Button.png" alt="Share with FB"/></div>
                                </div>
...
<div id="sidebarBoxLinklist" class="sidebarBox   ">
    ...
    <div class="sidebarBoxInnerBox">
        <div class="innerBox header ">
            <button type="button" id="button5225ee283eff4" title="Edit List" class="layoutButton edit<?php if($session->plus){echo 'White';}else{ echo 'Black';}?> <?=$green?>  " onclick="<?php if($session->plus){echo "window.location='spieler.php?s=2';";}?> return false;">
                <div class="button-container addHoverClick ">
                    <img src="img/x.gif" alt="">
                </div>
            </button>
