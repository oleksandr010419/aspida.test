        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Sopdu Explorer">
              Sopdu Explorer <span class="tribe">(Egyptians)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Sopdu Explorer"; title="Sopdu Explorer"; >
</div>
            ...
            <div id="t_desc">The Sopdu Explorer rides out into unknown territory to explore the area and count the soldiers of your enemies. They are also able to critically examine opposing villages and detect any weak points.</div>
