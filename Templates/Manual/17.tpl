      ...
      <div class="dialogContents">
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
			...
			<a href="manual.php?typ=4&gid=22;"><?php echo BLDG22?>&nbsp;</a><?php echo HLP_LEVEL?> 10 & <a href="manual.php?typ=4&gid=21;"><?php echo BLDG21?>&nbsp;</a><?php echo HLP_LEVEL?> 1</div>
