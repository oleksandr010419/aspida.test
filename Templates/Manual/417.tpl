...
// Include the buidata.php file to access the $bid17 array
include($buildataFilePath);

// Check if the first element of $bid17 exists
if (isset($bid17[1]['time'])) {
    // Extract the time value for the Marketplace at level 1
    $timeValue = $bid17[1]['time']/SPEED;
