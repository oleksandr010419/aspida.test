        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Resheph Chariot">
              Resheph Chariot <span class="tribe">(Egyptians)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Resheph Chariot"; title="Resheph Chariot"; >
</div>
            ...
            <div id="t_desc">The Resheph Chariot is well-versed in all fields of combat. It packs a heavy offensive punch as well as a very solid defense against infantry, though it truly excels at defending against cavalry. In return, they are very costly to train and consume plenty of crop.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=22;">Academy</a> Level 15, <a href="manual.php?typ=4&gid=20;">Stable</a> Level 10</div>
