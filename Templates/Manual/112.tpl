...
<body>
  ...
  <a href="manual.php?typ=4&gid=22;"><?php echo BLDG22?>&nbsp;</a><?php echo HLP_LEVEL?> 1 & <a href="manual.php?typ=4&gid=19;"><?php echo BLDG19?>&nbsp;</a><?php echo HLP_LEVEL?> 3
