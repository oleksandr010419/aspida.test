        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Spearman">
              Spearman <span class="tribe">(Teutons)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Spearman"; title="Spearman"; >
</div>
            ...
            <div id="t_desc">In the Teuton army, the Spearman’s task is defence. He is especially good against cavalry thanks to his weapons' length.<br></br>However, avoid using him in attacks, because his offensive capabilities are very low.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=22;">Academy</a> Level 1, <a href="manual.php?typ=4&gid=19;">Barracks</a> Level 3</div>
