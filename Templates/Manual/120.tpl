      ...
      <div class="dialogContents">
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
			...
			<a href="manual.php?typ=4&gid=25;"><?php echo BLDG25?>&nbsp;</a><?php echo HLP_LEVEL?> 10 or <a href="manual.php?typ=4&gid=26;"><?php echo BLDG26?>&nbsp;</a><?php echo HLP_LEVEL?> 10</div>
