        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Steppe Rider">
              Steppe Rider <span class="tribe">(Huns)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Steppe Rider"; title="Steppe Rider"; >
</div>
            ...
            <div id="t_desc">The Steppe Rider is an outstanding attacker who undergoes training faster than most other mounted warriors. As a result, however, they are very weak in defensive combat.</div>
