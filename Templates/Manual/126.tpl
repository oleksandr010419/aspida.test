        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Haeduan">
              Haeduan <span class="tribe">(Gauls)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Haeduan"; title="Haeduan"; >
</div>
            ...
            <div id="t_desc">The Haeduans are the Gaul's ultimate weapon for both offence and defence against cavalry. Few units can match their prowess.<br></br>However, their training and equipment are very expensive. So you should think very carefully if they will be worth the effort and expenses.</div>
