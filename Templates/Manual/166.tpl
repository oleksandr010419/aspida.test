        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Marauder">
              Marauder <span class="tribe">(Huns)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Marauder"; title="Marauder"; >
</div>
            ...
            <div id="t_desc">The Marauder is an absolute force to be reckoned with. With incredible attacking power and impressive speed, it overruns most defenses without a scratch on its armor.</div>
