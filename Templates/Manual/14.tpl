        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt=" Equites Legati">
               Equites Legati <span class="tribe">(Romans)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt=" Equites Legati"; title=" Equites Legati"; >
</div>
            ...
            <div id="t_desc">The Equites Legati are the roman reconnaissance troops. They are pretty fast and can spy on enemy villages in order to see resources and troops.<br></br>If there are no Scouts, Equites Legati or Pathfinders in the scouted village, the scouting remains unnoticed.</div>
