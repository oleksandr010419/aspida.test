...
<body>
  ...
  <a href="manual.php?typ=4&gid=12;"><?php echo BLDG12?>&nbsp;</a><?php echo HLP_LEVEL?> 1 & <a href="manual.php?typ=4&gid=22;"><?php echo BLDG22?>&nbsp;</a><?php echo HLP_LEVEL?> 5
</div>            <div class="buttons" style="display: none;"><button class="green dialogButtonOk ok textButtonV1" type="submit"></button></div>
          </div>
        </form>
      </div>
    </div>
