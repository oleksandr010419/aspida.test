        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Mercenary">
              Mercenary <span class="tribe">(Huns)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Mercenary"; title="Mercenary"; >
</div>
            ...
            <div id="t_desc">The Mercenary is a jack-of-all-trades. Their offensive and defensive performance can easily be compared to other units, but they do not excel in any form of combat. However, their moderate abilities are reflected by their moderate training costs.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=19;">Barracks</a> Level 1</div>
