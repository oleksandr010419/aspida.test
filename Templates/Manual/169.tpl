        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Logades">
               Logades <span class="tribe">(Huns)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Logades"; title="Logades"; >
			</div>
            ...
            <div id="t_desc">The Logades is the administrative leader of the Egyptians. They negotiate terms of surrender and, thanks to their charisma, they can win over enemy people to join your empire.The Logades have earned their position by defeating all challengers in a deadly battle of physical and mental prowess. Now they only leave home to conquer.<br></br>Every time they step into the village of an enemy, their powerful presence reduces the loyalty of the people to their previous owner, until they decide to join your command.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=16;">Rally Point </a> Level 10, <a href="manual.php?typ=4&gid=22;">Academy</a> Level 20</div>
