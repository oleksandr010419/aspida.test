        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt=" Senator">
               Senator <span class="tribe">(Romans)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt=" Senator"; title=" Senator"; >
</div>
            ...
            <div id="t_desc">The Senator is the tribe's chosen leader. He's a good speaker and knows how to convince others. He is able to persuade other villages to fight for your empire.<br></br>Every time the Senator speaks to the inhabitants of a village, the enemy's loyalty value decreases until the village is yours.</div>
