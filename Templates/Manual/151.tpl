...
<body>
  ...
  <a href="manual.php?typ=4&gid=19;"><?php echo BLDG19?>&nbsp;</a><?php echo HLP_LEVEL?> 1 <div class="buttons" style="display: none;"><button class="green dialogButtonOk ok textButtonV1" type="submit"></button></div>
          </div>
        </form>
      </div>
    </div>
