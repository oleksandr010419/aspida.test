        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Nomarch">
               Nomarch <span class="tribe">(Egyptians)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Nomarch"; title="Nomarch"; >
			</div>
            ...
            <div id="t_desc">The Nomarch is the administrative leader of the Egyptians. They negotiate terms of surrender and, thanks to their charisma, they can win over enemy people to join your empire.<br></br>With every visit of the Nomarch, the loyalty of the enemy’s population decreases until it is reduced to nothing and the people accept your rule.</div>
