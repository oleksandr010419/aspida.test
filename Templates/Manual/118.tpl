        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Catapult">
               Catapult <span class="tribe">(Teutons)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Catapult"; title="Catapult"; >
			</div>
            ...
            <div id="t_desc">The Catapult is an excellent long-distance weapon; it is used to destroy the fields and buildings of enemy villages. However, without escorting troops it is almost defenceless, so don't forget to send some of your troops with it.<br>Having a high-level rally point makes your catapults more accurate and gives you the option to target additional enemy buildings.HINT: Catapults CAN hit the cranny, trappers or stonemason's lodges when they target randomly.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=22;">Academy</a> Level 15, <a href="manual.php?typ=4&gid=21;">Workshop</a> Level 10</div>
