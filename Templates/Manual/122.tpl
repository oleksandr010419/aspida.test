        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Swordsman">
              Swordsman <span class="tribe">(Gauls)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Swordsman"; title="Swordsman"; >
</div>
            ...
            <div id="t_desc">The Swordsmen are more expensive than the Phalanx, but they are an offensive unit.<br></br>They are quite weak in defence, especially against cavalry.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=22;">Academy</a> Level 3, <a href="manual.php?typ=4&gid=12;">Smithy</a> Level 1</div>
