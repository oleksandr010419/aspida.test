...
<body>
  ...
  <a href="manual.php?typ=4&gid=22;"><?php echo BLDG22?>&nbsp;</a><?php echo HLP_LEVEL?> 3 & <a href="manual.php?typ=4&gid=12;"><?php echo BLDG12?>&nbsp;</a><?php echo HLP_LEVEL?> 1
