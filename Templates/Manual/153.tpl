        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Khopesh Warrior">
              Khopesh Warrior <span class="tribe">(Egyptians)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Khopesh Warrior"; title="Khopesh Warrior"; >
</div>
            ...
            <div id="t_desc">The Khopesh Warrior is an elite soldier boasting a strong offense and remarkable defense against other warriors on foot.</div>
