        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Bowman">
              Bowman <span class="tribe">(Huns)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Bowman"; title="Bowman"; >
</div>
            ...
            <div id="t_desc">The Bowman is your first choice for large offensive strikes. They love to be at the front lines, which is fortunate because of their puny defensive skills.</div>
