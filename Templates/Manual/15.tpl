<?php
$unit_number = 5;//Equites Imperatoris
      ...
      <div class="dialogContents">
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
			...
			<a href="manual.php?typ=4&gid=22;"><?php echo BLDG22?>&nbsp;</a><?php echo HLP_LEVEL?> 5 & <a href="manual.php?typ=4&gid=20;"><?php echo BLDG20?>&nbsp;</a><?php echo HLP_LEVEL?> 5 </div>
