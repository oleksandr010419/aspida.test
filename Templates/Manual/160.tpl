...
<body>
  ...
  <div class="dialog manual">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Settler">
               Settler <span class="tribe">(Egyptians)</span> 
            </h1>
    ...
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Settler"; title="Settler"; >
            ...
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=26;">Palace </a> Level 10 or <a href="manual.php?typ=4&gid=25;">Residence</a> Level 10</div>
