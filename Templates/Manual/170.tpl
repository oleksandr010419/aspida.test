        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Settler">
               Settler <span class="tribe">(Huns)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Settler"; title="Settler"; >
			</div>
            ...
            <div id="t_desc">Settlers are brave and daring citizens who move out of the village after much training to establish a new village in your honor. <br></br>As both the journey and the founding of the new village are very difficult, three settlers must stick together. They need a basic supplies of 750 units per resource.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=26;">Palace </a> Level 10 or <a href="manual.php?typ=4&gid=25;">Residence</a> Level 10, or <a href="manual.php?typ=4&gid=44;">Command Center</a> Level 10</div>
