        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Theutates Thunder">
              Theutates Thunder <span class="tribe">(Gauls)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Theutates Thunder"; title="Theutates Thunder"; >
</div>
            ...
            <div id="t_desc">Theutates Thunders are very fast and powerful cavalry units. They can carry a large amount of resources which makes them excellent raiders too.<br></br>When it comes to defence, their abilities are average at best.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=22;">Academy</a> Level 5, <a href="manual.php?typ=4&gid=20;">Stable</a> Level 3</div>
