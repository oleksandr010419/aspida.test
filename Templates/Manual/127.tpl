...
<body>
  ...
  <div class="dialog manual">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Ram">
               Ram <span class="tribe">(Gauls)</span> 
            </h1>
    ...
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Ram"; title="Ram"; >
            ...
            <div id="t_desc">The Ram is a heavy support weapon for your infantry and cavalry. Its task is to destroy the enemy walls and thus increase your troops’ chances of overcoming the enemy's fortifications.</div>
