        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt="Ash Warden">
              Ash Warden <span class="tribe">(Egyptians)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt="Ash Warden"; title="Ash Warden"; >
</div>
            ...
            <div id="t_desc">The Ash Warden is your standard defensive foot soldier with solid combat power. They fare exceptionally well against other infantry, yet its defense against cavalry should not be overlooked.</div>
            <div id="prereqs"><strong><br>Prerequisites</strong><br><a href="manual.php?typ=4&gid=22;">Academy</a> Level 1, <a href="manual.php?typ=4&gid=12;">Smithy</a> Level 1</div>
