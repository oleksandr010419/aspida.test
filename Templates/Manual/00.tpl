        ...
        <div id="troops" class="instantTabs">
          ...
          <div class="contentNavi tabNavi ">
            ...
            <div title="" class="container normal">
              ...
              <div class="background-end">&nbsp;</div>
              <div class="content">
                <a id="button6555b07377d7b" href="#tabContent3" class="tabItem">Gauls</a>
              </div>
            </div>
            <div title="" class="container normal">
              <div class="background-start">&nbsp;</div>
              <div class="background-end">&nbsp;</div>
              <div class="content">
                <a id="button6555b07377d7c" href="#tabContent4" class="tabItem">Egyptians</a>
              </div>
            </div>
            <div title="" class="container normal">
              <div class="background-start">&nbsp;</div>
              <div class="background-end">&nbsp;</div>
              <div class="content">
                <a id="button6555b07377d7d" href="#tabContent5" class="tabItem">Huns</a>
              </div>
            </div>
            <div title="" class="container normal">
              <div class="background-start">&nbsp;</div>
              <div class="background-end">&nbsp;</div>
              <div class="content">
                <a id="button6555b07377d7e" href="#tabContent6" class="tabItem">Spartans</a>
              </div>
            </div>
            <div class="clear"></div>
          </div>
          ...
          <div class="tabContainer6">
            <div id="tabContent6" class="tabContainer">
              <ul class="troops6">
                <?php
                $unit_info = [
                    71 => 'Hoplite',
                    72 => 'Sentinel',
                    73 => 'Shieldsman',
                    74 => 'Twinsteel Therion',
                    75 => 'Elpida Rider',
                    76 => 'Corinthian Crusher',
                    77 => 'Ram',
                    78 => 'Ballista',
                    79 => 'Ephor',
                    80 => 'Settler',
