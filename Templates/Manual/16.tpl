        ...
        <form action="?" method="get" accept-charset="UTF-8">
          ...
          <div class="content" id="dialogContent">
            ...
            <h1 class="titleInHeader">
              <img class="unit u<?php echo $unit_number; ?>" src="/img/x.gif" alt=" Equites Caesaris">
               Equites Caesaris <span class="tribe">(Romans)</span> 
            </h1>
            <div class="bigUnitSection" style="width: 160px; height: 260px;">
    <img class="unitSection u<?php echo $unit_number; ?>Section" src="/img/x.gif" alt=" Equites Caesaris"; title=" Equites Caesaris"; >
</div>
            ...
            <div id="t_desc">The Equites Caesaris are the heavy cavalry of Rome. They are very well armored and deal great amounts of damage, but all that armor and weaponry comes with a price. They are slow, carry less resources and feeding them is expensive.</div>
