...
//Retrieve the current date/time
        ...
        <tr>
            ...
            <td class="desc">
                +<b>25</b>% <img class="r1" src="img/x.gif" alt="Lamber" title="Lamber"/> <?= pluss34 ?><br/>
                <span class="run">
                    <?php
                    $tl_b1 = $datetime1;
                    if ($tl_b1 > $date2) {
        ...
        <tr>
            ...
            <td class="desc">
                +<b>25</b>% <img class="r2" src="img/x.gif" alt="Clay" title="Clay"/> <?= pluss35 ?><br/>
                <span class="run">
                    <?php
                    $tl_b2 = $datetime2;
                    if ($tl_b2 > $date2) {
		...
		<tr>
            <td class="desc">
                +<b><?php echo OFFENSE1_BONUS;?></b>% <img class="iReport iReport3" src="img/x.gif" alt="Offence bonus" title="Offence bonus"/> <?= pluss39 ?><br/>
                <span class="run">
                    <?php
                    ...
                    if ($tl_b4 < $date2) {
                        ...
                        echo "<font color='#B3B3B3' size='1'>" . pluss28 . ": <b> " . $holdtotday4 . "</b> " . pluss29 . " ";
                        echo "<b>  <span id='time21'>" . ($holdhr4) . "</span></b> " . pluss30 . " ";
                        echo "<b>  " . ($holdmr4) . "</b> " . pluss31 . "</font>";
                    }
                    ?>
                    &nbsp;	</span></td>
            <td class="dur"><?php
                ...
                ?></td>
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold"/><span id="offcost"><?php echo OFFENSE1_COST;?></span></td>
            <td <span class="none">
                    <?php
                    if ($session->gold>OFFENSE1_COST && $tl_b4 < $date2) {
                        echo getAjaxButton(pluss25,"return Travian.Game.buyplus(21)",$disabl,"green","action21");
                    }
					elseif ($session->gold>OFFENSE1_COST && $tl_b4 > $date2) {
                        echo getAjaxButton(pluss26,"return Travian.Game.buyplus(21)",$disabl,"green","action21");
                    } else {
		...
		<tr>
            <td class="desc">
                +<b><?php echo DEFENCE1_BONUS;?></b>% <img class="iReport iReport5" src="img/x.gif" alt="Defence bonus" title="Defence bonus"/> <?= pluss40 ?><br/>
                <span class="run">
                    <?php
                    ...
                    if ($tl_b4 < $date2) {
                        print "<font color='#B3B3B3' size='1'><span id='ost31'></span><b><span id='time31'></span></b><span id='hour31'></span></font>";
                    } else {
            ...
            <td class="dur"><?php
                ...
                ?></td>
            <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold"/><span id="defcost"><?php echo DEFENCE1_COST;?></span></td>
            <td <span class="none">
                    <?php
                    if ($session->gold>DEFENCE1_COST && $tl_b4 < $date2) {
                        echo getAjaxButton(pluss25,"return Travian.Game.buyplus(31)",$disabl,"green","action31");
                    }
					elseif ($session->gold>DEFENCE1_COST && $tl_b4 > $date2) {
                        echo getAjaxButton(pluss26,"return Travian.Game.buyplus(31)",$disabl,"green","action31");
                    } else {
                        echo noGoldButton(pluss27);
                    }
                    ?>
        ...
        <?php if (SELL_RES) { ?>
            <tr>
                ...
                <td class="dur"><?= PLUS20 ?></td>
                <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold" /><span id='costres'><?= COSTRES ?></span></td>
                <td class="act"><span class="none">
                        <?php
        ...
        if (SELL_CP) {
            ...
            <tr>
                ...
                <td class="dur"><?= PLUS20 ?></td>
                <td class="cost"><img src="img/x.gif" class="gold" alt="Gold" title="Gold"/><span id='costcp'><?= COSTCP ?></span></td>
                <td class="act"><span class="none">
                        <?php
...
<table class="plusFunctions" cellpadding="1" cellspacing="1">
    ...
    <tbody>
        <tr>
            ...
            <td class="cost"><img src="img/x.gif" class="gold" alt="gold" title="Gold">250</td>
            <td class="act">
                <?php
                if ($session->gold >= 250) {
                    if (!$session->goldclub) {
