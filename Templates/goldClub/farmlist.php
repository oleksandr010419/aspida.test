...
<div id="list<?php echo $lid; ?>" class="listEntry">
				...
				<div class="round spacer listTitle" >
						<div class="listTitleText">
							...
							<div class="openedClosedSwitch switchOpened" onclick="Travian.Game.RaidList.toggleList(<?php echo $lid; ?>);">
								<?=farmlist1?>						
							</div>
						</div>
						<div class="clear"></div>
...
?>
	...
	<div class="addSlot">
        <button type="button" onclick="Travian.Game.RaidList.addSlot(<?php echo $lid; ?>);" class="green">
...
?>
		<div class="clear"></div>
                        ...
                        <button type="submit" class="green <?=(($lstart<time()-300)?'':'disabled')?>" <?=(($lstart<time()-300)?'':'onclick="return false;"')?>>
                            <div class="button-container addHoverClick ">
                                <div class="button-background">
                                    <div class="buttonStart">
                                        <div class="buttonEnd">
                                ...
                                <div class="button-content"><?= farmlist7 ?>
                                    ...
                                    <?php if($lstart>time()-300){?><span id='timer<?=$timer?>'><?=$generator->getTimeFormat($lstart+300-time())?></span>
            <?php } ?>
            </div>
                            </div>
                        </button>
...
<?php } }?>
<div class="options">
	<a class="arrow" href="build.php?gid=16&t=99&action=addList"><?=farmlist9?></a>
</div>
<?php
}
