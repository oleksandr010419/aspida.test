...
if (isset($_POST['action']) == 'addSlot' && $_POST['lid']) {
	...
	if($session->tribe==3 || $session->tribe==7){ 
		$_POST['t3'] = 0;
	}elseif($session->tribe!=3 && $session->tribe!=7){
		$_POST['t4'] = 0;
	}
    ...
    if ($_POST['x'] != '' && $_POST['y'] != '') {
        ...
        if (!$exist) {
			...
			if($database->checkRaidList($village->wid,$Wref)){
				$errormsg .= "Cannot add that village to any raidlist... again...";			
			}else{
				$coor = $village->coor;
				...
				try{
					...
					$errormsg .= "Trying to do something nasty,eh?";
				}
			}
	...
	header("Location: build.php?id=39&t=99&action=addList&error=nolist");
}
?>
                            ...
                            <td class="target">
                                ...
                                <div class="coordinatesInput">
                                    ...
                                    <div class="xCoord">
                                        ...
                                        <input value="<?php echo $_REQUEST['x']; ?>" name="x" id="xCoordInput" class="text coordinates x ">
                                    ...
                                    <div class="yCoord">
                                        ...
                                        <input value="<?php echo $_REQUEST['y']; ?>" name="y" id="yCoordInput" class="text coordinates y ">
...
for ($i = 1; $i <= 10; $i++) {
    ...
    $spy='';
	if($i==3 && $session->tribe==3 || $i==3 && $session->tribe==7){ 
		$spy='disabled="disabled"';
	}elseif($i==4 && $session->tribe!=3 && $session->tribe!=7){
		$spy='disabled="disabled"';
	}
